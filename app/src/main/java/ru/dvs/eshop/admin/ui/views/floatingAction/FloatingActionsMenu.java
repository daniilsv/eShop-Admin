package ru.dvs.eshop.admin.ui.views.floatingAction;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                mAddButton.layout(addButtonLeft, addButtonY + 0, addButtonLeft + mAddButton.getMeasuredWidth(), addButtonY + mAddButton.getMeasuredHeight());
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    child.layout(childX, childY + 0, childX + child.getMeasuredWidth(), childY + child.getMeasuredHeight());
                    ...
                    if (label != null) {
                        ...
                        label.layout(labelLeft + 0, labelTop, labelRight + 0, labelTop + label.getMeasuredHeight());
            ...
            case EXPAND_RIGHT:
                ...
                mAddButton.layout(addButtonX + 0, addButtonTop, addButtonX + mAddButton.getMeasuredWidth(), addButtonTop + mAddButton.getMeasuredHeight());
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    child.layout(childX + 0, childY, childX + child.getMeasuredWidth(), childY + child.getMeasuredHeight());
